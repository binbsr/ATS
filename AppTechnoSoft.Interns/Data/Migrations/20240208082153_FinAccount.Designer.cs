...
namespace AppTechnoSoft.Interns.Data.Migrations
{
    ...
    [Migration("20240208082153_FinAccount")]
    partial class FinAccount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AppTechnoSoft.Interns.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "21e10d3e-51e3-4f5f-ab21-7249ea386de9",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "42bba37d-b489-40d0-a28d-a590ceac5775",
                            Email = "rawal.bishnu@live.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedUserName = "RAWAL.BISHNU@LIVE.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEHqHch1v92ttjXAvWaX/EKEe6Rs/QFwTfG98yL/JwQLRfYf5jPWxxBGzcA8lyWXeqw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "93b7aca7-b0e5-4b3f-a2dc-7823632cd996",
            ...
            modelBuilder.Entity("AppTechnoSoft.Interns.Data.Models.Widget", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2024, 2, 8, 14, 6, 52, 588, DateTimeKind.Local).AddTicks(1678),
                            CreatedBy = "Seed",
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2024, 2, 8, 14, 6, 52, 588, DateTimeKind.Local).AddTicks(1704),
                            CreatedBy = "Seed",
                            Description = "An display item in home page",
                        ...
                        {
                            Id = 3,
                            Created = new DateTime(2024, 2, 8, 14, 6, 52, 588, DateTimeKind.Local).AddTicks(1706),
                            CreatedBy = "Seed",
                            Description = "An display item in home page",
                        ...
                        {
                            Id = 4,
                            Created = new DateTime(2024, 2, 8, 14, 6, 52, 588, DateTimeKind.Local).AddTicks(1708),
                            CreatedBy = "Seed",
                            Description = "An display item in home page",
                        ...
                        {
                            Id = 5,
                            Created = new DateTime(2024, 2, 8, 14, 6, 52, 588, DateTimeKind.Local).AddTicks(1709),
                            CreatedBy = "Seed",
                            Description = "An display item in home page",
                        ...
                        {
                            Id = 6,
                            Created = new DateTime(2024, 2, 8, 14, 6, 52, 588, DateTimeKind.Local).AddTicks(1711),
                            CreatedBy = "Seed",
                        ...
                        {
                            Id = 7,
                            Created = new DateTime(2024, 2, 8, 14, 6, 52, 588, DateTimeKind.Local).AddTicks(1713),
                            CreatedBy = "Seed",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "999556a0-4c04-45ad-84cc-811814e7a580",
                            ConcurrencyStamp = "999556a0-4c04-45ad-84cc-811814e7a580",
                            Name = "SuperAdmin",
                            NormalizedName = "SUPERADMIN"
                        },
                        new
                        {
                            Id = "52a1c35a-e1c5-4466-8879-953a975a3bb1",
                            ConcurrencyStamp = "52a1c35a-e1c5-4466-8879-953a975a3bb1",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "86b30e13-0c78-4436-b297-3993f840ba12",
                            ConcurrencyStamp = "86b30e13-0c78-4436-b297-3993f840ba12",
                            Name = "Trainee",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "21e10d3e-51e3-4f5f-ab21-7249ea386de9",
                            RoleId = "999556a0-4c04-45ad-84cc-811814e7a580"
                        });
                });
