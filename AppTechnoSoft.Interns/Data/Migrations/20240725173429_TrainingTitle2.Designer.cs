...
namespace AppTechnoSoft.Interns.Data.Migrations
{
    ...
    [Migration("20240725173429_TrainingTitle2")]
    partial class TrainingTitle2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AppTechnoSoft.Interns.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "a023dd75-3a54-4878-8cc9-a59b851cb393",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "dea114b0-92a3-40f3-b599-1719fcacd30d",
                            Email = "rawal.bishnu@live.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedUserName = "RAWAL.BISHNU@LIVE.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAELFtPVjllB9VVJNIm9imKiQ46QeMqkl9wVSWbRJPR55h9YUbW2zY4q3TJ/sqBR8PNg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "78150947-1952-486b-a3b9-f9e2670687e2",
            ...
            modelBuilder.Entity("AppTechnoSoft.Interns.Data.Models.Widget", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2024, 7, 25, 23, 19, 28, 259, DateTimeKind.Local).AddTicks(4140),
                            CreatedBy = "Seed",
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2024, 7, 25, 23, 19, 28, 259, DateTimeKind.Local).AddTicks(4158),
                            CreatedBy = "Seed",
                            Description = "An display item in home page",
                        ...
                        {
                            Id = 3,
                            Created = new DateTime(2024, 7, 25, 23, 19, 28, 259, DateTimeKind.Local).AddTicks(4160),
                            CreatedBy = "Seed",
                            Description = "An display item in home page",
                        ...
                        {
                            Id = 4,
                            Created = new DateTime(2024, 7, 25, 23, 19, 28, 259, DateTimeKind.Local).AddTicks(4162),
                            CreatedBy = "Seed",
                            Description = "An display item in home page",
                        ...
                        {
                            Id = 5,
                            Created = new DateTime(2024, 7, 25, 23, 19, 28, 259, DateTimeKind.Local).AddTicks(4164),
                            CreatedBy = "Seed",
                            Description = "An display item in home page",
                        ...
                        {
                            Id = 6,
                            Created = new DateTime(2024, 7, 25, 23, 19, 28, 259, DateTimeKind.Local).AddTicks(4166),
                            CreatedBy = "Seed",
                        ...
                        {
                            Id = 7,
                            Created = new DateTime(2024, 7, 25, 23, 19, 28, 259, DateTimeKind.Local).AddTicks(4168),
                            CreatedBy = "Seed",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "b6177807-55ae-4a45-8731-de5626872d78",
                            ConcurrencyStamp = "b6177807-55ae-4a45-8731-de5626872d78",
                            Name = "SuperAdmin",
                            NormalizedName = "SUPERADMIN"
                        },
                        new
                        {
                            Id = "1ad8d025-56da-49ce-8ada-3bf97ed433de",
                            ConcurrencyStamp = "1ad8d025-56da-49ce-8ada-3bf97ed433de",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "c7e241a4-4305-4aca-9e12-6a7334d202a2",
                            ConcurrencyStamp = "c7e241a4-4305-4aca-9e12-6a7334d202a2",
                            Name = "Trainee",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "a023dd75-3a54-4878-8cc9-a59b851cb393",
                            RoleId = "b6177807-55ae-4a45-8731-de5626872d78"
                        },
                        new
                        {
                            UserId = "a023dd75-3a54-4878-8cc9-a59b851cb393",
                            RoleId = "1ad8d025-56da-49ce-8ada-3bf97ed433de"
                        },
                        new
                        {
                            UserId = "a023dd75-3a54-4878-8cc9-a59b851cb393",
                            RoleId = "c7e241a4-4305-4aca-9e12-6a7334d202a2"
                        });
                });
